...
describe("asyncHandler", function () {
    it("should forward rejected promise errors to next", function (done) {
        var _this = this;
        var app = express();
        var expectedError = new Error("async route error");
        app.get("/", __1.asyncHandler(function (_req, _res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("should not interfere when the handler resolves successfully", function (done) {
        var _this = this;
        var app = express();
        app.get("/", __1.asyncHandler(function (_req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                res.json({ ok: true });
                return [2];
            });
    ...
    it("should forward a promise rejection (non-Error value) to next", function (done) {
        var app = express();
        app.get("/", __1.asyncHandler(function (_req, _res) {
...
//# sourceMappingURL=asyncHandler.spec.js.map