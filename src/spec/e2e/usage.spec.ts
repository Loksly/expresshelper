...
describe("Should work as expected", () => {
    ...
    it("should work for promises resolving with data when asking for /", function (this: { router: Application }, done) {
        this.router.get("/", (_req: Request, res: Response) => {
    ...
    it("should work for promises rejecting with error when asking for /", function (this: { router: Application }, done) {
        this.router.get("/", (_req: Request, res: Response) => {
    ...
    it("should work for callback functions with success values when asking for /", function (this: { router: Application }, done) {
        this.router.get("/", (_req: Request, res: Response) => {
    ...
    it("should work for callback functions with error values when asking for /", function (this: { router: Application }, done) {
        this.router.get("/", (_req: Request, res: Response) => {
    ...
    it("should work for error functions with numeric code when asking for /", function (this: { router: Application }, done) {
    ...
    it("should work for error functions with string message when asking for /", function (this: { router: Application }, done) {
        const err = { "err": "my error"};
        this.router.get("/", (_req: Request, res: Response) => {
